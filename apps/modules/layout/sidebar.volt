                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            {% elseif session.get('user_aktif')['jenis_user'] == 4 %}
                                <li>
                                <a href="{{ url('/dashboard')}}"><i class="si si-puzzle"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                                </li>
                                <li>
                                    <a href="{{ url('/data-apoteker')}}"><i class="si si-layers"></i><span class="sidebar-mini-hide">Resep</span></a>
                                </li>
                            {% else %}
                                <li>
                                <a href="{{ url('/dashboard')}}"><i class="si si-puzzle"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                                ...
                                <li>
                                    <a href="{{ url('/data-apoteker')}}"><i class="si si-layers"></i><span class="sidebar-mini-hide">Data Apoteker</span></a>
                                </li>
                                <li>
                                    <a href="{{ url('/jadwal-dokter')}}"><i class="si si-layers"></i><span class="sidebar-mini-hide">Jadwal Dokter</span></a>
                                </li>
